...
export function initPasswordSettings() {
    ...
    if (saveButton) {
        saveButton.addEventListener('click', () => handleSavePassword(newPasswordInput, confirmPasswordInput));
    }
    if (passwordEditIcon) {
        passwordEditIcon.addEventListener('click', () => togglePasswordEdit(newPasswordInput, confirmPasswordInput));
    }
}

...
from . import views
from .views import CustomUserViewSet, CookieTokenObtainPairView, CookieTokenVerifyView
...
urlpatterns = [
	...
	path('current_username_email/', views.current_username_email, name='current_username_email'),
